...
const PAGE_SIZE=12;
let dataset, papers=[],state={q:'',category:'',quick:'all',year:'',sort:'newest',page:1,facets:{},tags:[],paper:'',view:'library',paper:''};
