...
LABELS={'author':'作者／发布者','object':'什么在进化','executor':'谁执行','modifier':'谁来改','verdict':'反馈是什么','seed':'基础 harness','cycle':'更新规则','train':'训练／进化数据','debug':'调试／选版本数据','test':'测试数据与判分','isolation':'数据隔离与证据边界','novelty':'方法特点','scope':'关注范围','framework':'分析框架','feedback':'反馈与证据','evidence':'证据来源','reading':'怎么读','limits':'适用范围与局限','data':'使用的数据','use':'如何使用','actors':'谁在做研究'}
